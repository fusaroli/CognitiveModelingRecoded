...
ggplot(draws_df)+
  ...
  geom_density(aes(`beta[1]`), fill="blue", alpha=0.3) +
  geom_density(aes(`beta[2]`), fill="blue", alpha=0.3) +
  geom_density(aes(`beta[3]`), fill="blue", alpha=0.3) +
  theme_classic()

ggplot(draws_df)+
  geom_point(aes(alphaprior, betaprior), color="red", alpha=0.3) +
  geom_point(aes(`alpha[1]`, `beta[1]`), color="blue", alpha=0.3) +
  geom_point(aes(`alpha[2]`, `beta[2]`), color="green", alpha=0.3) +
  geom_point(aes(`alpha[3]`, `beta[3]`), color="purple", alpha=0.3) +
  theme_classic()
