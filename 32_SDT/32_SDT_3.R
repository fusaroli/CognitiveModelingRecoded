source(here("32_SDT", "heit_rotello.RData")) #loads the data
...
file <- file.path(here("32_SDT", "32_SDT_3.stan"))
...
ggplot(draws_df)+
  geom_point(aes(criterionprior, sample(discriminabilityprior)), color="red", alpha=0.05) +
